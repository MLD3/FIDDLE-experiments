...
python -m FIDDLE.run \
    ...
    --data_path="$DATAPATH/features,comparison/dt=48.0,benchmark,outcome=mortality,T=48.0,dt=1.0/" \
    --T=48.0 \
    --dt=48.0 \
    --theta_1=0.001 \
    --theta_2=0.001 \
...
#     --input_fname="$DATAPATH/features/benchmark,outcome=mortality,T=48.0,dt=1.0/input_data.p" \
#     --population="$DATAPATH/population/pop.mortality_benchmark.csv" \
#     --data_path="$DATAPATH/features,comparison/dt=24.0,benchmark,outcome=mortality,T=48.0,dt=1.0/" \
#     --T=48.0 \
#     --dt=24.0 \
#     --theta_1=0.001 \
#     --theta_2=0.001 \
...
#     --input_fname="$DATAPATH/features/benchmark,outcome=mortality,T=48.0,dt=1.0/input_data.p" \
#     --population="$DATAPATH/population/pop.mortality_benchmark.csv" \
#     --data_path="$DATAPATH/features,comparison/dt=12.0,benchmark,outcome=mortality,T=48.0,dt=1.0/" \
#     --T=48.0 \
#     --dt=12.0 \
#     --theta_1=0.001 \
#     --theta_2=0.001 \
...
#     --input_fname="$DATAPATH/features/benchmark,outcome=mortality,T=48.0,dt=1.0/input_data.p" \
#     --population="$DATAPATH/population/pop.mortality_benchmark.csv" \
#     --data_path="$DATAPATH/features,comparison/dt=4.0,benchmark,outcome=mortality,T=48.0,dt=1.0/" \
#     --T=48.0 \
#     --dt=4.0 \
#     --theta_1=0.001 \
#     --theta_2=0.001 \
