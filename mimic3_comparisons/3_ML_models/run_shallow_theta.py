...
print('EXPERIMENT:', 'THETA={},model={},outcome={},T={},dt={}'.format(theta, model_name, task, T, dt))

# Create checkpoint directories
import pathlib
pathlib.Path("./checkpoint/THETA={},model={},outcome={},T={},dt={}/".format(theta, model_name, task, T, dt)).mkdir(parents=True, exist_ok=True)

######
# Data
import lib.data as data
if task == 'mortality':
    tr_loader, va_loader, te_loader = data.get_benchmark_splits_theta(fuse=True, theta=theta)
else:
    assert False
...
try:
    np.savetxt(
        'output/THETA={},outcome={},T={},dt={}/{},coef.txt'.format(theta, task, T, dt, model_name), 
...
evaluate.save_test_predictions(y_te, yte_pred, model_type, './output/THETA={},outcome={},T={},dt={}/'.format(theta, task, T, dt))
