...
print('EXPERIMENT:', 'DT={},model={},outcome={},T={},dt={}'.format(DT, model_name, task, T, dt))

# Create checkpoint directories
import pathlib
pathlib.Path("./checkpoint/DT={},model={},outcome={},T={},dt={}/".format(DT, model_name, task, T, dt)).mkdir(parents=True, exist_ok=True)

######
# Data
import lib.data as data
if task == 'mortality':
    tr_loader, va_loader, te_loader = data.get_benchmark_splits_dt(fuse=True, DT=DT)
else:
    assert False
...
try:
    np.savetxt(
        'output/DT={},outcome={},T={},dt={}/{},coef.txt'.format(DT, task, T, dt, model_name), 
...
evaluate.save_test_predictions(y_te, yte_pred, model_type, './output/DT={},outcome={},T={},dt={}/'.format(DT, task, T, dt))
